 ...
 *
 * The client will stop receiving notifications when the resource changes.
 */
class UnsubscribeRequest implements RequestInterface
{
    ...
    public static function fromArray(array $data): self
    {
        if (! isset($data['params']['uri'])) {
            throw ValidationError::requiredFieldMissing('uri', 'UnsubscribeRequest');
        }
    ...
    {
        return uniqid('unsubscribe_', true);
    }
}
