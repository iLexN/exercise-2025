...
/**
 * Request to list prompts available on the server.
 *
 * Supports pagination through cursor-based navigation.
 */
class ListPromptsRequest implements RequestInterface
{
    private string $method = ProtocolConstants::METHOD_PROMPTS_LIST;
    ...
    {
        return uniqid('list_prompts_', true);
    }
}
